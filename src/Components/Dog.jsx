...
const Dog = () => {
    ...
    useEffect(() => {
        ...
        const tomorrowland = document.querySelector(
            `.title[img-title="tomorrowland"]`
        )
        ...
        const navyPier = document.querySelector(
            `.title[img-title="navy-pier"]`
        )
        ...
        const msiChicago = document.querySelector(
            `.title[img-title="msi-chicago"]`
        )
        ...
        const kikk = document.querySelector(
            `.title[img-title="kikk"]`
        )
        ...
        const kennedy = document.querySelector(
            `.title[img-title="kennedy"]`
        )
        ...
        const opera = document.querySelector(
            `.title[img-title="opera"]`
        )
